...
// test('natural language', entityResult, '£5 using £1/kg', 5, { kilograms: 1 });
...
// test('operators on colors and entities', colorResult, '#800 + 20%', '#ee0000');
// test('operators on colors and entities', colorResult, '#800 - 20%', '#220000');
